...
namespace PlayableAdsTool
{
    public class LocalizationSettingsWindow : EditorWindow
    {
        ...
        [MenuItem("Window/◆ Playable Localization/Settings")]
        public static void ShowWindow()
        {
            GetWindow<LocalizationSettingsWindow>("Localization Settings");
        }

        [MenuItem("Window/◆ Playable Localization/Reset")]
        public static void ResetSettings()
        {
            if (EditorUtility.DisplayDialog("Playable Localization", "Do you want to reset settings?", "Yes", "No"))
            {
