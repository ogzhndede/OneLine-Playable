...
namespace PathCreation.Utility {
    ...
    public static class CubicBezierUtility {
        ...
        /// Returns point at time 't' (between 0 and 1)  along bezier curve defined by 4 points (anchor_1, control_1, control_2, anchor_2)
        public static Vector3 EvaluateCurve ([Bridge.Ref] Vector3 a1, [Bridge.Ref] Vector3 c1, [Bridge.Ref] Vector3 c2, [Bridge.Ref] Vector3 a2, float t) {
            t = Mathf.Clamp01 (t);
        ...
        /// This is the vector tangent to the curve at that point
        public static Vector3 EvaluateCurveDerivative ([Bridge.Ref] Vector3 a1, [Bridge.Ref] Vector3 c1, [Bridge.Ref] Vector3 c2, [Bridge.Ref] Vector3 a2, float t) {
            t = Mathf.Clamp01 (t);
        ...
        ///Returns the second derivative of the curve at time 't'
        public static Vector3 EvaluateCurveSecondDerivative ([Bridge.Ref] Vector3 a1, [Bridge.Ref] Vector3 c1, [Bridge.Ref] Vector3 c2, [Bridge.Ref] Vector3 a2, float t) {
            t = Mathf.Clamp01 (t);
        ...
        /// Calculates the normal vector (vector perpendicular to the curve) at specified time
        public static Vector3 Normal ([Bridge.Ref] Vector3 a1, [Bridge.Ref] Vector3 c1, [Bridge.Ref] Vector3 c2, [Bridge.Ref] Vector3 a2, float t) {
        ...
        public static Bounds CalculateSegmentBounds ([Bridge.Ref] Vector3 p0, [Bridge.Ref] Vector3 p1, [Bridge.Ref] Vector3 p2, [Bridge.Ref] Vector3 p3) {
        ...
        public static float EstimateCurveLength ([Bridge.Ref] Vector3 p0, [Bridge.Ref] Vector3 p1, [Bridge.Ref] Vector3 p2, [Bridge.Ref] Vector3 p3) {
        ...
        public static List<float> ExtremePointTimes ([Bridge.Ref] Vector3 p0, [Bridge.Ref] Vector3 p1, [Bridge.Ref] Vector3 p2, [Bridge.Ref] Vector3 p3) {
