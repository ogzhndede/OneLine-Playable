...
namespace PathCreation.Utility {
    public static class MathUtility {
        ...
        public static Vector3 TransformPoint ([Bridge.Ref] Vector3 p, Transform t, PathSpace space) {
        ...
        public static Vector3 InverseTransformPoint ([Bridge.Ref] Vector3 p, Transform t, PathSpace space) {
            var original = LockTransformToSpace (t, space);
        ...
        public static Vector3 TransformVector ([Bridge.Ref] Vector3 p, Transform t, PathSpace space) {
            var original = LockTransformToSpace (t, space);
        ...
        public static Vector3 InverseTransformVector ([Bridge.Ref] Vector3 p, Transform t, PathSpace space) {
            var original = LockTransformToSpace (t, space);
        ...
        public static Vector3 TransformDirection ([Bridge.Ref] Vector3 p, Transform t, PathSpace space) {
            var original = LockTransformToSpace (t, space);
        ...
        public static Vector3 InverseTransformDirection ([Bridge.Ref] Vector3 p, Transform t, PathSpace space) {
            var original = LockTransformToSpace (t, space);
        ...
        public static bool LineSegmentsIntersect ([Bridge.Ref] Vector2 a1, [Bridge.Ref] Vector2 a2, [Bridge.Ref] Vector2 b1, [Bridge.Ref] Vector2 b2) {
        ...
        public static bool LinesIntersect ([Bridge.Ref] Vector2 a1, [Bridge.Ref] Vector2 a2, [Bridge.Ref] Vector2 a3, [Bridge.Ref] Vector2 a4) {
            return (a1.x - a2.x) * (a3.y - a4.y) - (a1.y - a2.y) * (a3.x - a4.x) != 0;
        }

        public static Vector2 PointOfLineLineIntersection ([Bridge.Ref] Vector2 a1, [Bridge.Ref] Vector2 a2, [Bridge.Ref] Vector2 a3, [Bridge.Ref] Vector2 a4) {
        ...
        public static Vector2 ClosestPointOnLineSegment ([Bridge.Ref] Vector2 p, [Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 b) {
            Vector2 aB = b - a;
            Vector2 aP = p - a;
        ...
        public static Vector3 ClosestPointOnLineSegment ([Bridge.Ref] Vector3 p, [Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b) {
            Vector3 aB = b - a;
            Vector3 aP = p - a;
            float sqrLenAB = aB.sqrMagnitude;
        ...
        public static int SideOfLine ([Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 b, [Bridge.Ref] Vector2 c) {
            return (int) Mathf.Sign ((c.x - a.x) * (-b.y + a.y) + (c.y - a.y) * (b.x - a.x));
        }

        /// returns the smallest angle between ABC. Never greater than 180
        public static float MinAngle ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 c) {
            return Vector3.Angle ((a - b), (c - b));
        }

        public static bool PointInTriangle ([Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 b, [Bridge.Ref] Vector2 c, [Bridge.Ref] Vector2 p) {
