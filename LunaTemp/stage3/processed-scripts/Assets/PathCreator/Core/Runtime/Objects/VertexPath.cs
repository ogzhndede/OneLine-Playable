...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public Vector3 GetClosestPointOnPath ([Bridge.Ref] Vector3 worldPoint) {
        ...
        public float GetClosestTimeOnPath ([Bridge.Ref] Vector3 worldPoint) {
            TimeOnPathData data = CalculateClosestPointOnPathData (worldPoint);
        ...
        public float GetClosestDistanceAlongPath ([Bridge.Ref] Vector3 worldPoint) {
            TimeOnPathData data = CalculateClosestPointOnPathData (worldPoint);
        ...
        TimeOnPathData CalculateClosestPointOnPathData ([Bridge.Ref] Vector3 worldPoint) {
