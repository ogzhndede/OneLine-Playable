...
namespace PathCreation {
 ...
 IsClosed = isClosed;
        ...
        /// Get world space position of point
        public void SetPoint (int i, [Bridge.Ref] Vector3 localPosition, bool suppressPathModifiedEvent = false) {
        ...
        public void AddSegmentToEnd ([Bridge.Ref] Vector3 anchorPos) {
            if (isClosed) {
                return;
            }
        ...
        public void AddSegmentToStart ([Bridge.Ref] Vector3 anchorPos) {
            if (isClosed) {
                return;
            }
        ...
        public void SplitSegment ([Bridge.Ref] Vector3 anchorPos, int segmentIndex, float splitTime) {
